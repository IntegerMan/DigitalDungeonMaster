...
{
    private readonly BasiliskKernel _kernel;
    private readonly IServiceProvider _serviceProvider;
    private readonly RequestContextService _context;
    private readonly ILogger<AdventureRunner> _logger;

    public AdventureRunner(BasiliskKernel kernel, IServiceProvider serviceProvider, LoggerFactory loggerFactory, RequestContextService context)
    {
        _kernel = kernel;
